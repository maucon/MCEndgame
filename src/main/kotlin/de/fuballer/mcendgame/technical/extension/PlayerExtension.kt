...
object PlayerExtension {
    ...
    fun Player.setArtifacts(value: List<Artifact>) = PersistentDataUtil.setValue(this, TypeKeys.ARTIFACTS, value)
    fun Player.getArtifacts() = PersistentDataUtil.getValue(this, TypeKeys.ARTIFACTS)
    fun Player.setHealOnBlockArtifactActivation(value: Long) = PersistentDataUtil.setValue(this, TypeKeys.HEAL_ON_BLOCK_ARTIFACT_ACTIVATION, value)
    fun Player.getHealOnBlockArtifactActivation() = PersistentDataUtil.getValue(this, TypeKeys.HEAL_ON_BLOCK_ARTIFACT_ACTIVATION)

    fun Player.getHighestArtifactTier(artifactType: ArtifactType) =
        this.getArtifacts()
