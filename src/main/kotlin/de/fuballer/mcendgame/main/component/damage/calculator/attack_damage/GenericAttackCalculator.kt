...
object GenericAttackCalculator : DamageCalculator {
    override fun isActive(source: DamageSource) = source.type().isOf(CustomDamageTypes.GENERIC_ATTACK)
            || source.type().isOf(CustomDamageTypes.GENERIC_ATTACK_UNBLOCKABLE)
