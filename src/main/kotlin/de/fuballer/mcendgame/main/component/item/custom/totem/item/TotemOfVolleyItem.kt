...
class TotemOfVolleyItem(
    ...
    override fun getCustomAttributes(tier: Int) =
        when (tier) {
            0 -> listOf(
                CustomAttribute(CustomAttributeTypes.ADDITIONAL_PROJECTILES, 0, IntRoll(IntBounds(2))),
            )
            ...
            2 -> listOf(
                CustomAttribute(CustomAttributeTypes.ADDITIONAL_PROJECTILES, 0, IntRoll(IntBounds(4))),
