...
enum class Shovel(
    ...
    override val rollableCustomAttributes = listOf(
        ...
        RandomOption(
            weight = 1,
            listOf(
                LevelRestrictedRandomOption(weight = 50, tier = 1, requiredLevel = 0, RollableCustomAttribute(CustomAttributeTypes.SPELL_DAMAGE, 3, DoubleBounds(1.0, 2.5))),
                LevelRestrictedRandomOption(weight = 10, tier = 2, requiredLevel = 5, RollableCustomAttribute(CustomAttributeTypes.SPELL_DAMAGE, 2, DoubleBounds(2.5, 4.0))),
                LevelRestrictedRandomOption(weight = 1, tier = 3, requiredLevel = 10, RollableCustomAttribute(CustomAttributeTypes.SPELL_DAMAGE, 1, DoubleBounds(4.0, 5.0))),
            )
        ),
        RandomOption(
            weight = 1,
