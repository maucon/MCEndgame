...
class RadiantDawn(
    ...
    override fun getCustomAttributes() = listOf(
        ...
        RollableCustomAttribute(CustomAttributeTypes.INCREASED_HEALING_PER_SPELL_DAMAGE, 0, DoubleBounds(0.03, 0.05)),
        RollableCustomAttribute(CustomAttributeTypes.SPELL_DAMAGE, 0, DoubleBounds(2.0, 4.0)),
