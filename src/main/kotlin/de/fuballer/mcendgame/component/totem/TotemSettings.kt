...
object TotemSettings {
    ...
    val TOTEM_ITEM_EFFECT_PREFIX = listOf(
        TextComponent.empty(),
        TextComponent.create("When equipped:", NamedTextColor.GRAY)
    )
    val TOTEM_ITEM_DUNGEON_DISCLAIMER = listOf(
        TextComponent.empty(),
        TextComponent.create("The totem's effect is only active", NamedTextColor.DARK_GRAY).decorate(TextDecoration.ITALIC),
        TextComponent.create("when in the totem inventory and", NamedTextColor.DARK_GRAY).decorate(TextDecoration.ITALIC),
        TextComponent.create("whilst inside a dungeon.", NamedTextColor.DARK_GRAY).decorate(TextDecoration.ITALIC)
    )
    ...
    val LORE_COLOR: NamedTextColor = NamedTextColor.BLUE
}