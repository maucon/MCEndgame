...
object CustomEntitySettings {
    val ZOMBIE_DATA = CustomEntityData(
        canHaveWeapons = true, isRanged = false, canHaveArmor = true, dropBaseLoot = true, hideEquipment = false, isSilent = false,
    ...
    val SKELETON_DATA = CustomEntityData(
        canHaveWeapons = true, isRanged = true, canHaveArmor = true, dropBaseLoot = true, hideEquipment = false, isSilent = false,
    ...
    val CREEPER_DATA = CustomEntityData(
        canHaveWeapons = true, isRanged = false, canHaveArmor = true, dropBaseLoot = true, hideEquipment = true, isSilent = false,
