...
@Component
class EquipmentCalculationCommand : CommandHandler {
    override fun initialize(plugin: JavaPlugin) = plugin.getCommand(EquipmentCalculationSettings.COMMAND_NAME)!!.setExecutor(this)
    ...
    private fun Double.round() =
        BigDecimal(this)
            .setScale(EquipmentCalculationSettings.NUMBER_DECIMAL_PLACES, RoundingMode.HALF_UP)
            .toDouble()
}
