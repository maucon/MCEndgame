...
object TitansEmbraceItemType : CustomItemType {
    ...
    override val attributes = listOf(
        RollableCustomAttribute(AttributeType.ARMOR, -5.0, -2.0),
        RollableCustomAttribute(AttributeType.MAX_HEALTH, 3.0, 6.0),
        RollableCustomAttribute(AttributeType.MAX_HEALTH_INCREASE, 0.1, 0.2),
        RollableCustomAttribute(AttributeType.REGEN_ON_DAMAGE_TAKEN, 5.0, 8.0),
        RollableCustomAttribute(AttributeType.SIZE_INCREASE, 0.1, 0.2),
    )
}