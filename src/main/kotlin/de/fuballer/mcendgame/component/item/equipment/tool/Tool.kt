...
enum class Tool(
    ...
    MACE(
        ...
        listOf(),
        listOf(
            RandomOption(1, ItemEnchantment.MENDING),
            RandomOption(1, ItemEnchantment.UNBREAKING_1),
            RandomOption(1, ItemEnchantment.UNBREAKING_2),
            RandomOption(1, ItemEnchantment.UNBREAKING_3),
            RandomOption(1, ItemEnchantment.CURSE_OF_VANISHING),
            RandomOption(1, ItemEnchantment.SMITE_1),
            RandomOption(1, ItemEnchantment.SMITE_2),
            RandomOption(1, ItemEnchantment.SMITE_3),
            RandomOption(1, ItemEnchantment.SMITE_4),
            RandomOption(1, ItemEnchantment.SMITE_5),
            RandomOption(1, ItemEnchantment.BANE_OF_ARTHROPODS_1),
            RandomOption(1, ItemEnchantment.BANE_OF_ARTHROPODS_2),
            RandomOption(1, ItemEnchantment.BANE_OF_ARTHROPODS_3),
            RandomOption(1, ItemEnchantment.BANE_OF_ARTHROPODS_4),
            RandomOption(1, ItemEnchantment.BANE_OF_ARTHROPODS_5),
            RandomOption(1, ItemEnchantment.FIRE_ASPECT_1),
            RandomOption(1, ItemEnchantment.FIRE_ASPECT_2),
            RandomOption(1, ItemEnchantment.DENSITY_1),
            RandomOption(1, ItemEnchantment.DENSITY_2),
            RandomOption(1, ItemEnchantment.DENSITY_3),
            RandomOption(1, ItemEnchantment.DENSITY_4),
            RandomOption(1, ItemEnchantment.DENSITY_5),
            RandomOption(1, ItemEnchantment.BREACH_1),
            RandomOption(1, ItemEnchantment.BREACH_2),
            RandomOption(1, ItemEnchantment.BREACH_3),
            RandomOption(1, ItemEnchantment.BREACH_4),
            RandomOption(1, ItemEnchantment.WINDBURST_1),
            RandomOption(1, ItemEnchantment.WINDBURST_2),
            RandomOption(1, ItemEnchantment.WINDBURST_3),
        )
    ),
    FISHING_ROD(
