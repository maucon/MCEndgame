...
object CrownOfConflictItemType : CustomItemType {
    ...
    override val attributes = listOf(
        RollableCustomAttribute(AttributeType.HEALTH_RESERVATION, 0.15, 0.3),
        RollableCustomAttribute(AttributeType.MAX_HEALTH_INCREASE, 0.1, 0.2),
        RollableCustomAttribute(AttributeType.MAX_HEALTH, -4.0, 4.0),
        RollableCustomAttribute(AttributeType.SIZE_INCREASE, -0.05, 0.05),
    )
}