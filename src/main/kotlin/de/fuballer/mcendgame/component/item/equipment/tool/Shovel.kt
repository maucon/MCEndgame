...
enum class Shovel(
    ...
    WOODEN(
        ...
        listOf(
            BaseAttribute(VanillaAttributeTypes.ATTACK_DAMAGE, 2.5),
    ...
    STONE(
        ...
        listOf(
            BaseAttribute(VanillaAttributeTypes.ATTACK_DAMAGE, 3.5),
            BaseAttribute(VanillaAttributeTypes.ATTACK_SPEED, 1.0)
        )
    ),
    IRON(
        ...
        listOf(
            BaseAttribute(VanillaAttributeTypes.ATTACK_DAMAGE, 4.5),
            BaseAttribute(VanillaAttributeTypes.ATTACK_SPEED, 1.0)
        )
    ),
    DIAMOND(
        ...
        listOf(
            BaseAttribute(VanillaAttributeTypes.ATTACK_DAMAGE, 5.5),
            BaseAttribute(VanillaAttributeTypes.ATTACK_SPEED, 1.0)
        )
    ),
    NETHERITE(
        ...
        listOf(
            BaseAttribute(VanillaAttributeTypes.ATTACK_DAMAGE, 6.5),
            BaseAttribute(VanillaAttributeTypes.ATTACK_SPEED, 1.0)
        )
    );
