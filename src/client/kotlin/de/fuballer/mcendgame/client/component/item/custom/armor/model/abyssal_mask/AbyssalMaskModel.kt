package de.fuballer.mcendgame.client.component.item.custom.armor.model.abyssal_mask
...
class AbyssalMaskModel<S : HumanoidRenderState>(
    root: ModelPart
) : HumanoidModel<S>(root) {
    companion object {
        val MODEL_LAYER = ModelLayerLocation(IdentifierUtil.default("abyssal_mask"), "main")
        ...
        fun getTexturedModelData(): LayerDefinition {
            ...
            val helmet = head.addOrReplaceChild(
                "helmet", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation(0.25F))
                    .texOffs(0, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F)
            )
